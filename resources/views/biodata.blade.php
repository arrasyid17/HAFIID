...
<div class="w-full px-6 py-6 mx-auto">
  <div class="flex flex-wrap -mx-3">
    <div class="w-full px-3">
      ...
      <p class="text-lg leading-relaxed">Ini adalah biodata ku</p>
      ...
      <img src="{{ asset('assets/img/fotosaya.jpeg') }}" alt="Foto Profil" class="mt-4 w-24 h-24" style="width: 150px; height: 150px;">
    </div>
  </div>
</div>
@endsection
